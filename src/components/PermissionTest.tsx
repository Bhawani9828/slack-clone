...
export default function PermissionTest() {
  ...
  const checkPermissions = async () => {
    try {
      ...
      setCameraPermission(cameraPermission.state === 'prompt' ? 'unknown' : cameraPermission.state as 'granted' | 'denied');
      
      // Check microphone permission
      const micPermission = await navigator.permissions.query({ name: 'microphone' as PermissionName });
      setMicrophonePermission(micPermission.state === 'prompt' ? 'unknown' : micPermission.state as 'granted' | 'denied');

      // Listen for permission changes
      cameraPermission.onchange = () => setCameraPermission(cameraPermission.state === 'prompt' ? 'unknown' : cameraPermission.state as 'granted' | 'denied');
      micPermission.onchange = () => setMicrophonePermission(micPermission.state === 'prompt' ? 'unknown' : micPermission.state as 'granted' | 'denied');
